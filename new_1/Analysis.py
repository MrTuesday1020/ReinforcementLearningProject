...
plt.plot(x_axis_1, mean_line_1,label='mean_as1=%d'%mean_1)
...
plt.plot(x_axis_2, mean_line_2,label='mean_alp1=%d'%mean_2)
...
plt.plot(x_axis_3, mean_line_3,label='mean_alp2=%d'%mean_3)
...
plt.plot(x_axis_4, mean_line_4,label='mean_alp3=%d'%mean_4)

plt.ylabel('Performance measure')
plt.xlabel('Number of training')
plt.legend()
plt.savefig('pic/figure_'+'as_vs_greedy')
