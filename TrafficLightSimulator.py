...
#				reward = 0
			...
			if len(block_list_11) > 1 and amber_light != 1:
				reward -= 1
			if len(block_list_12) > 1 and amber_light != 1:
				reward -= 1
			if len(block_list_21) > 1 and amber_light != 2:
				reward -= 1
			if len(block_list_22) > 1 and amber_light != 2:
				reward -= 1
