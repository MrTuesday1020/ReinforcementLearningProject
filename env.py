...
light_11 = canvas.create_rectangle(48*unit, 48*unit, 49*unit, 49*unit, fill='spring green', width=0)
light_21 = canvas.create_rectangle(51*unit, 48*unit, 52*unit, 49*unit, fill='red2', width=0)
