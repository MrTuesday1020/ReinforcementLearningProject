...
while current_training < amount_of_training:
	...
	while master_clock <= period_of_time * amount_of_episode:
		...
		index_of_this_episode += 1
		if index_of_this_episode == amount_of_episode:
	...
	performance_file = 'output/performance_' + str(amount_of_training)
